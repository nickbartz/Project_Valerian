...
const int MAX_NUM_ITEM_TEMPLATES = 50;
const int MAX_NUM_BLUEPRINTS = 50;
...
enum Structure_Animations
{
	STRUCTURE_ANIMATION_NULL,
	STRUCTURE_ANIMATION_INCREMENT_UNTIL_COMPLETE,
	STRUCTURE_ANIMATION_DECREMENT_UNTIL_COMPLETE,
	STRUCTURE_ANIMATION_PAUSE,
	STRUCTURE_ANIMATION_INCREMENT_REPEAT
};
