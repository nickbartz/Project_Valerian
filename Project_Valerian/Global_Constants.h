...
{
	SCAFFOLD_STATE_PRE_INITIATION,
	SCAFFOLD_STATE_PARTS_NEEDED_NO_JOB_SENT,
	SCAFFOLD_STATE_PARTS_NEEDED_JOB_SENT,
	SCAFFOLD_STATE_NO_PARTS_NEEDED_NO_JOB_SENT,
	SCAFFOLD_STATE_NO_PARTS_NEEDED_JOB_SENT
};
