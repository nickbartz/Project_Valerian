...
{
public:
	UI_Window_Player_Diagnostic(Global_Service_Locator* sLocator = NULL, SDL_Rect base_rect = { 100,100,300,300 }) :UI_Window_Generic(sLocator, WINDOW_PLAYER_DIAGNOSTIC, "Diagnostics", base_rect)
	{
...
{
public:
	UI_Window_Structure_Create(Global_Service_Locator* sLocator = NULL, SDL_Rect base_rect = { 400,100,SPRITE_SIZE*5,SPRITE_SIZE*6 }) :UI_Window_Generic(sLocator, WINDOW_CREATE_STRUCTURE, "Structure Create", base_rect)
	{
		service_locator = sLocator;
		...
		structure_create_wall = UI_Panel_Structure_Create_Type(service_locator, 6, 5, WINDOW_CREATE_STRUCTURE, PANEL_STRUCTURE_CREATE_WALL, { 0,window_title_height + panel_bar_height,base_rect.w,base_rect.h - window_title_height - panel_bar_height });
		structure_create_floor = UI_Panel_Structure_Create_Type(service_locator, 6, 5, WINDOW_CREATE_STRUCTURE, PANEL_STRUCTURE_CREATE_FLOOR, { 0,window_title_height + panel_bar_height,base_rect.w,base_rect.h - window_title_height - panel_bar_height });
		structure_create_misc = UI_Panel_Structure_Create_Type(service_locator, 6, 5, WINDOW_CREATE_STRUCTURE, PANEL_STRUCTURE_CREATE_MISC, { 0,window_title_height + panel_bar_height,base_rect.w,base_rect.h - window_title_height - panel_bar_height });
...
{
public:
	UI_Window_Object_Diagnostic(Global_Service_Locator* sLocator = NULL, SDL_Rect base_rect = {0,0,SPRITE_SIZE*18,SPRITE_SIZE*10}) :UI_Window_Generic(sLocator, WINDOW_OBJECT_DIAGNOSTIC, "Entity Diagnostic", base_rect)
	{
		service_locator = sLocator;
		...
		object_inventory = UI_Panel_Object_Inventory(service_locator, WINDOW_OBJECT_DIAGNOSTIC, { 0,window_title_height + panel_bar_height,base_rect.w,base_rect.h - window_title_height - panel_bar_height });
...
{
public:
	UI_Window_Screen_Buttons(Global_Service_Locator* sLocator = NULL, SDL_Rect base_rect = { 0,SCREEN_HEIGHT - 5*SPRITE_SIZE,SPRITE_SIZE * 1,SPRITE_SIZE * 5 }):UI_Window_Generic(sLocator, WINDOW_SCREEN_BUTTONS, "Actions", base_rect)
	{
		service_locator = sLocator;
